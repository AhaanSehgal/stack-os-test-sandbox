...
export declare class UserController {
    ...
    constructor(baseUrl: string, triaName?: string, environment?: ENV);
    get_tID(): Promise<any>;
    /**
     *
     * @deprecated
    ...
    searchUser(term: string): Promise<any>;
    getHomeScreenHistory(): Promise<unknown>;
    getAllAddresses(triaName: string): Promise<GetAllAddressesResponse>;
    getSubnames(): Promise<any>;
    getAllHistory(filter?: 'all' | 'transactionSent' | 'transactionReceived', filterChainNames?: string[], triaName?: string): Promise<any>;
    getOnChainConversation(withTriaName: string, triaName?: string): Promise<any>;
    getAssets(filterChainNames?: string[], filter?: 'all' | 'favorites', sort?: 'amountAsc' | 'amountDesc', triaName?: string): Promise<any>;
    getAssetsForATriaName(triaName: string, filterChainNames?: [], sort?: 'amountAsc' | 'amountDesc'): Promise<any>;
    getAsset(chainName: string, tokenAddress?: string, triaName?: string): Promise<any>;
    getAssetBalanceForATriaName(triaName: string, chainName: string, tokenAddress?: string): Promise<any>;
    getAssetDetails(chainName: string, tokenAddress?: string, triaName?: string): Promise<any>;
    ...
    getAssetHistory(chainName: string, tokenAddress?: string, triaName?: string): Promise<any>;
    getNFTs(sort?: 'A-Z' | 'Z-A' | 'Ascending buy date' | 'Descending buy date', filter?: 'all' | 'favorites', filterByCollectionId?: string, filterChainNames?: string[], triaName?: string): Promise<any>;
    getNFTCollections(filterChainNames?: string[], triaName?: string): Promise<any>;
    getNFTDetails(chainName: string, tokenAddress: string, tokenId: string, triaName?: string): Promise<any>;
    ...
    getRampnalysisUrl(address: string, coinSymbol: string): Promise<RampnalysisUrlResponse>;
    getRampnalysisSupportedToken(query: string): Promise<RampnalysisSupportedResponse>;
    ...
    getChainNameByTriaName(triaName: string): Promise<GetChainNameByTriaName>;
