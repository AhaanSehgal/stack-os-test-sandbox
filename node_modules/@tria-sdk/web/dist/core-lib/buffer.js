...
(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) {
    if (!e[i]) {
        var c = "function" == typeof reqqq && reqqq;
        if (!f && c)
            return c(i, !0);
        if (u)
            return u(i, !0);
...
} return n[i].exports; } for (var u = "function" == typeof reqqq && reqqq, i = 0; i < t.length; i++)
            ...
            (function (Buffer) {
                (function () {
                    ...
                    if (!Buffer.TYPED_ARRAY_SUPPORT && typeof console !== 'undefined' &&
                        ...
                        console.error('This browser lacks typed array (Uint8Array) support which is reqqqd by ' +
