...
const useSendNft = (calldata) => {
    ...
    const sendNft = () => {
        ...
        const iframe = (0, helper_1.createIframe)(signIframeUrl, 'sdkSendNft');
        setIsLoading(false);
    ...
    (0, react_1.useEffect)(() => {
        const detect = (event) => {
            ...
            if ((eventData === null || eventData === void 0 ? void 0 : eventData.type) === 'closeIframe' && (eventData === null || eventData === void 0 ? void 0 : eventData.callFrom) == 'sendNft') {
                setData(eventData === null || eventData === void 0 ? void 0 : eventData.data);
                setIsLoading(false);
                (_a = document.getElementById('sdkSendNft')) === null || _a === void 0 ? void 0 : _a.remove();
            }
        };
